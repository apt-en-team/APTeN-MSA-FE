...
export const socialSignup = async (body) => {
  const res = await apiClient.post('/auth/social/signup', body)
  return unwrapApiData(res)
}
...
export const sendPasswordResetMail = async (body) => {
  const res = await apiClient.post('/auth/password/forgot', body)
  return unwrapApiData(res)
}
...
export const sendSmsCode = async (body) => {
  const res = await apiClient.post('/auth/sms/send', body)
  return unwrapApiData(res)
}

// SMS 인증번호 검증
export const verifySmsCode = async (body) => {
  const res = await apiClient.post('/auth/sms/verify', body)
  return unwrapApiData(res)
}

// 이메일 중복 확인
export const checkEmail = async (params) => {
  const res = await apiClient.get('/auth/check-email', { params })
  return unwrapApiData(res)
}
...
export const deleteMyAccount = async (body) => {
  const res = await apiClient.delete('/users/me', { data: body })
  return unwrapApiData(res)
}

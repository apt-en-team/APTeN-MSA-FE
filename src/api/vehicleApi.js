...
export const createVehicle = async (body) => {
  const res = await apiClient.post('/vehicles', body)
  return unwrapApiData(res)
}

// 내 차량 수정
export const updateVehicle = async (vehicleId, body) => {
  const res = await apiClient.patch(`/vehicles/${vehicleId}`, body)
  return unwrapApiData(res)
}
...
export const checkLicensePlate = async (params) => {
  const res = await apiClient.get('/vehicles/check-license-plate', { params })
  return unwrapApiData(res)
}
...
export const getAdminVehicles = async (params) => {
  const res = await apiClient.get('/admin/vehicles', { params })
  return unwrapApiData(res)
}

// 관리자 차량 상세 조회
export const getAdminVehicleDetail = async (vehicleId) => {
  const res = await apiClient.get(`/admin/vehicles/${vehicleId}`)
  return unwrapApiData(res)
}
...
export const rejectVehicle = async (vehicleId, body) => {
  const res = await apiClient.patch(`/admin/vehicles/${vehicleId}/reject`, body)
  return unwrapApiData(res)
}

// 차량 정책 설정
export const saveVehiclePolicies = async (body) => {
  const res = await apiClient.put('/admin/vehicle-policies', body)
  return unwrapApiData(res)
}

// 차량 정책 조회
export const getVehiclePolicies = async () => {
  const res = await apiClient.get('/admin/vehicle-policies')
  return unwrapApiData(res)
}
